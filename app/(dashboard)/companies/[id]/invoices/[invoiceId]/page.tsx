...
export default async function InvoicePage({
  ...
  return (
    <div className="space-y-5 bg-slate-50 p-6 min-h-full">
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex flex-wrap justify-between gap-4">
        <div>
          <div className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-500">Invoice status</div>
      ...
      {items?.map(i => {
        ...
        return (
          <div key={i.id} className="rounded-xl border border-slate-200 bg-white p-3 text-sm shadow-sm">
